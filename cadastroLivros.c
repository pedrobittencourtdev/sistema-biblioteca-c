...
void listarEmprestimos(const struct Livro *biblioteca, struct Emprestimo *emprestimos, int totalEmprestimos);
...
//---Função para listar todos os empréstimos realizados---//
void listarEmprestimos(const struct Livro *biblioteca, struct Emprestimo *emprestimos, int totalEmprestimos){
